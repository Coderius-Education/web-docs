---
title: Les 9 – Formulier-data ophalen
sidebar_label: 9. Formulier-data ophalen
hide_table_of_contents: true
---

import CodeEditor from '@site/src/components/CodeEditor';

# Les 9 – Formulier-data ophalen
...
In [HTML-les 12 (Formulieren)](/docs/html-css/formulieren) leerde je hoe je een formulier bouwt. Tot nu toe deed dat formulier nog niets — typen kon je wel, maar de tekst kwam nergens terecht.
...
`naam` bevat nu wat de gebruiker getypt heeft. Dat is een **string** (zie [les 7](/docs/js-basics/operatoren-types)).
...
Lees de gekozen optie uit met `document.getElementById('moment').value`. Gebruik `if`/`else` (uit [les 8](/docs/js-basics/if-else)) om de juiste begroeting te kiezen.
...
[← Les 8 – Beslissingen (if/else)](/docs/js-basics/if-else)
