...
Met JavaScript maak je een statische pagina interactief — knoppen die iets doen, formulieren die reageren, animaties, spelletjes. Een uitgebreide introductie vind je in [les 0 – Wat is JavaScript](/docs/js-basics/intro-javascript).
:::
...
[← Les 0 – Wat is JavaScript](/docs/js-basics/intro-javascript) | [Les 2 – Inline stijl →](/docs/js-basics/inline-stijl)
