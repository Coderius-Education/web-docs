---
title: Les 2 – Inline stijl
sidebar_label: 2. Inline stijl
...
Bekijk de startcode in de editor. Beantwoord de vraag hieronder **voordat** je op een knop klikt.
...
[← Les 1 – Inline onclick](/docs/js-basics/inline-onclick) | [Les 3 – De script-tag →](/docs/js-basics/script-tag)
