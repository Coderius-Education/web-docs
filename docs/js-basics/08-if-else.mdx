---
title: Les 8 – Beslissingen met if/else
sidebar_label: 8. Beslissingen (if/else)
hide_table_of_contents: true
---

import CodeEditor from '@site/src/components/CodeEditor';

# Les 8 – Beslissingen met if/else
...
Tussen de haakjes staat een **voorwaarde** — iets dat `true` of `false` oplevert (zie [les 7](/docs/js-basics/operatoren-types) over vergelijken). Als de voorwaarde `true` is, voert JavaScript de regels tussen `{ ... }` uit. Anders slaat hij het blok over.
...
[← Les 7 – Waarden en operatoren](/docs/js-basics/operatoren-types) | [Les 9 – Formulier-data ophalen →](/docs/js-basics/formulier-data)
