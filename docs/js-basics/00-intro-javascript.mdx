---
title: Les 0 – Wat is JavaScript?
sidebar_label: 0. Wat is JavaScript?
hide_table_of_contents: true
---

# Les 0 – Wat is JavaScript?
...
1. **Inline** — direct in een HTML-attribuut zoals `onclick="..."` (les 1 en 2)
2. **Intern** — in een `<script>` tag binnenin je HTML (les 3)
3. **Extern** — in een apart `script.js` bestand (les 4)
...
[Les 1 – Inline onclick →](/docs/js-basics/inline-onclick)
