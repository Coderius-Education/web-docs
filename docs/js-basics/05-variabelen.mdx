...
Je hebt een **beslissing** nodig: alleen aftrekken als de score boven 0 is. In JavaScript schrijf je dat met `if`. De volledige uitleg krijg je in [les 8 (Beslissingen)](/docs/js-basics/if-else), maar voor nu kun je dit patroon kopiëren:
