---
title: Les 3 – Tekst opmaken met CSS
sidebar_label: 3. Tekst opmaken met CSS
...
:::note Let op
`<link>` is **geen** klikbare link voor de bezoeker — het koppelt alleen je CSS-bestand aan de pagina. Klikbare links (waar je echt naartoe kunt) leer je in [les 5](/docs/html-css/paginas-koppelen).
:::
