...
`:focus` is vooral nuttig voor [formulieren (les 12)](/docs/html-css/formulieren) — geef een actief invoerveld of geselecteerde knop een opvallende rand zodat de gebruiker ziet waar hij/zij bezig is. Belangrijk voor toegankelijkheid (mensen die met Tab navigeren).
:::
