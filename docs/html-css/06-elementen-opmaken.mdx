---
title: Les 6 – Ruimte rond elementen
sidebar_label: 6. Ruimte rond elementen
hide_table_of_contents: true
---

import CodeEditor from '@site/src/components/CodeEditor';

# Les 6 – Ruimte rond elementen
...
In [les 10](/docs/html-css/border-en-dimensies) leer je hoe je deze blokken ook een rand en een vaste breedte geeft.

---

[← Les 5 – Pagina's koppelen](/docs/html-css/paginas-koppelen) | [Les 7 – CSS Klassen →](/docs/html-css/css-klassen)
