---
title: Les 10 – Randen en afmetingen
sidebar_label: 10. Randen en afmetingen
hide_table_of_contents: true
---

import CodeEditor from '@site/src/components/CodeEditor';

# Les 10 – Randen en afmetingen
...
In [les 6](/docs/html-css/elementen-opmaken) leerde je over padding en margin. Nu voegen we drie nieuwe stijlen toe:
...
[← Les 9 – Flexbox](/docs/html-css/flexbox) | [Les 11 – Semantische HTML →](/docs/html-css/semantische-html)
